...
public class AttachmentController {
    ...
    @GetMapping
    public ResponseEntity<List<Attachment>> getAttachments(@PathVariable Long todoId) {
        return ResponseEntity.ok(attachmentService.getAttachmentsByTodo(todoId));
    }
    ...
    public ResponseEntity<Attachment> uploadFile(
        ...
        Attachment attachment = attachmentService.uploadFile(todoId, file, currentUser);
